                                    ...
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="/admin/factory/create" class="btn btn-primary">ADD
                                                    Factory</a>
                                            </div>
                                                    ...
                                                    <c:forEach var="factory" items="${factories}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="/admin/factory/delete/${factory.id}" class="btn btn-danger" onclick="return confirmDelete();">Delete</a>
                                                            </td>
                                                        </tr>
